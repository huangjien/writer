        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildShortcutGroup(context, 'Sidebar', textStyle, [
                _ShortcutItem('Toggle Left Sidebar', getShortcutLabel('B')),
                _ShortcutItem('Toggle AI Sidebar', getShortcutLabel('I')),
                _ShortcutItem('Chapters', getShortcutLabel('1')),
                _ShortcutItem('Characters', getShortcutLabel('2')),
                _ShortcutItem('Scenes', getShortcutLabel('3')),
                _ShortcutItem('Summary', getShortcutLabel('4')),
              ]),
            ],
          ),
        ),
